...
export type TranslationKey =
  ...
  | 'dashboard.todaysDetections.title'
  | 'dashboard.todaysDetections.noDetections'
  | 'dashboard.todaysDetections.checkBackLater'
  | 'dashboard.todaysDetections.allLoaded'
  ...
  | 'detections.title'
  | 'detections.searchPlaceholder'
  | 'detections.noResults'
  ...
  | 'detections.filters.title'
  | 'detections.filters.species'
  | 'detections.filters.speciesPlaceholder'
  | 'detections.filters.dateRange'
  | 'detections.filters.from'
  | 'detections.filters.to'
  | 'detections.filters.confidence'
  | 'detections.filters.timeOfDay'
  | 'detections.filters.hourRange'
  | 'detections.filters.verified'
  | 'detections.filters.verifiedAll'
  | 'detections.filters.verifiedOnly'
  | 'detections.filters.unverifiedOnly'
  | 'detections.filters.apply'
  | 'detections.filters.clearAll'
  ...
  | 'settings.mobile.main.description'
  | 'settings.mobile.ui.description'
  | 'settings.mobile.audio.description'
  | 'settings.mobile.filters.description'
  | 'settings.mobile.integrations.description'
  | 'settings.mobile.security.description'
  | 'settings.mobile.species.description'
  | 'settings.mobile.notifications.description'
  | 'settings.mobile.support.description'
  ...
  | 'settings.main.sections.userInterface.interface.locale.requiresModernUI'
  ...
  | 'settings.notifications.push.comingSoon'
  | 'settings.notifications.push.comingSoonDescription'
  ...
  | 'settings.audio.streams.typeLockedNote'
  ...
  | 'settings.audio.audioFilters.emptyState.title'
  | 'settings.audio.audioFilters.emptyState.description'
  ...
  | 'settings.security.saveAuthSettings'
  | 'settings.security.validation.passwordRequired'
  | 'settings.security.validation.googleClientIdRequired'
  | 'settings.security.validation.googleClientSecretRequired'
  | 'settings.security.validation.githubClientIdRequired'
  | 'settings.security.validation.githubClientSecretRequired'
  | 'settings.security.validation.subnetRequired'
